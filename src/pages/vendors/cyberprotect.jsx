...
export default function CyberprotectPage() {
    return (
            ...
            mx-auto">
                <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
                    ...
                    flex items-center justify-center">
                        <div className="px-4">
                            <img src={Logo} alt="Киберпротект (ООО «Киберпротект»)" className="w-full h-auto object-contain svg-big-icon"/>
                        </div>
                ...
                px-1 xs:px-2">
                    <p className="text-justify">
                        <strong>Компания Киберпротект</strong> является российским разработчиком программных продуктов и решений, специализирующихся на защите данных, резервном копировании и обеспечении непрерывности бизнеса. Ключевая специализация компании охватывает создание систем для резервного копирования и восстановления данных в физических, виртуальных и облачных средах, разработку DLP-систем для предотвращения утечек, а также построение гиперконвергентных инфраструктур и организацию безопасного файлового обмена. На рынке компания позиционируется как поставщик комплексных, преимущественно импортозамещающих ИТ- и ИБ-решений.
                        <br/><br/>
                        В портфель продуктов компании входят решения для резервного копирования «Кибер Бэкап», платформа для защиты от утечек данных «Кибер DLP», система для организации защищенного файлового обмена и совместной работы «Кибер Файлообмен», а также платформа для создания гиперконвергентной инфраструктуры «Кибер Инфраструктура». Штаб-квартира компании расположена в Москве. Киберпротект активно развивает экосистему технологического партнерства, обеспечивая совместимость своих продуктов с широким спектром отечественных операционных систем, СУБД и аппаратных комплексов."
                    </p>
                </div>
                <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
                    ...
                    <a href="https://cyberprotect.ru/" target="_blank">
