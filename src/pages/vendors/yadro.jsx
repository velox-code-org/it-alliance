...
export default function YadroPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  YADRO (АО «Ай-Эс-Джи» или АО «Ядро»)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="YADRO (АО «Ай-Эс-Джи» или АО «Ядро»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>YADRO</strong> — российский разработчик и производитель высокотехнологичного оборудования, специализирующийся на создании полного спектра решений для центров обработки данных (ЦОД), корпоративной ИТ-инфраструктуры и телекоммуникаций. Ключевая специализация компании охватывает производство серверов (включая линейку VEGMAN), систем хранения данных (СХД, включая платформу TATLIN), планшетных компьютеров (линейка KVADRA) и сетевого оборудования.
              <br/><br/>
              На рынке YADRO позиционируется как ведущий поставщик технологической инфраструктуры, способный реализовывать масштабные проекты по импортозамещению и цифровой трансформации в ключевых отраслях экономики. Компания делает акцент на собственных разработках (R&D) и производстве, обеспечивая полный цикл создания сложных программно-аппаратных комплексов.
            </p>
          </div>
