import Vector370 from "../../assets/vendors/delta-logo370.png";
import Vector480 from "../../assets/vendors/delta-logo480.png";
import Vector576 from "../../assets/vendors/delta-logo576.png";
import Vector768 from "../../assets/vendors/delta-logo768.png";
import Vector992 from "../../assets/vendors/delta-logo992.png";
import Vector1024 from "../../assets/vendors/delta-logo1024.png";
import Vector1260 from "../../assets/vendors/delta-logo1260.png";
import Vector1440 from "../../assets/vendors/delta-logo1440.png";
import Vector1600 from "../../assets/vendors/delta-logo1600.png";
import Vector1920 from "../../assets/vendors/delta-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function DeltaPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Delta Electronics</b> — крупнейший международный концерн,
            разрабатывающий широкий спектр интеллектуальных решений в области
            силовой электроники. <br />
            <br />
            Также Delta Electronics занимается разработкой и производством
            проекционных систем, светодиодных решений, автомобильной
            электроники, сетевого оборудования. Под брендом Delta выпускается
            энергосберегающее оборудование для улучшения качества жизни, а также
            изделия силовой электроники. <br />
            <br />
            Более чем за 10 лет присутствия в России бренд Delta получил
            заслуженное признание и статус надежного и доверенного партнера
            ведущих организаций, для которых бесперебойное энергоснабжение 24
            часа сутки/ 7 дней в неделю имеет решающее значение для бизнеса.
            География реализованных проектов Delta Electronics покрывает
            территорию всей России, в том числе самые отдаленные регионы.
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://deltronics.ru/" target="_blank">
            <button
