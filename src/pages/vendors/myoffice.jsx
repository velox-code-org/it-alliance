        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="МойОфис (ООО «МойОфис»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>МойОфис</strong> — российский разработчик, создающий комплексные программные решения для корпоративных клиентов, государственных организаций, образовательных учреждений и частных пользователей. Ключевая специализация компании охватывает два основных направления: офисные приложения для работы с документами (редакторы текста, таблиц, презентаций, а также инструменты для работы с PDF и графикой) и платформу для коммуникаций Squadus, включающую корпоративный мессенджер, аудио- и видеозвонки, вебинары и календари.
              <br/><br/>
              На рынке компания позиционируется как поставщик целостной экосистемы для повышения продуктивности командной работы, обеспечивающей «бесшовные» сценарии перехода между различными задачами — от редактирования документов до проведения видеоконференций. Продукты МойОфис ориентированы на безопасную работу с конфиденциальной информацией и имеют сертификаты ФСТЭК России (в том числе по 4-му уровню доверия для почтовой системы Mailion).
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://myoffice.ru/" target="_blank">
