import Vector370 from "../../assets/vendors/juniper-logo370.png";
import Vector480 from "../../assets/vendors/juniper-logo480.png";
import Vector576 from "../../assets/vendors/juniper-logo576.png";
import Vector768 from "../../assets/vendors/juniper-logo768.png";
import Vector992 from "../../assets/vendors/juniper-logo992.png";
import Vector1024 from "../../assets/vendors/juniper-logo1024.png";
import Vector1260 from "../../assets/vendors/juniper-logo1260.png";
import Vector1440 from "../../assets/vendors/juniper-logo1440.png";
import Vector1600 from "../../assets/vendors/juniper-logo1600.png";
import Vector1920 from "../../assets/vendors/juniper-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function JuniperPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Juniper Networks</b> — американская компания, производитель
            телекоммуникационного оборудования, преимущественно для
            интернет-провайдеров, корпораций и государственного сектора.
            Основана Pradeep Sindhu в 1996 году. Штаб-квартира — в Саннивейле
            (Калифорния, Кремниевая долина). Название компании Juniper с
            английского переводится как можжевельник. <br />
            <br />
            С момента создания и по настоящее время, Juniper Networks
            специализируется на разработке скоростных решений по обработке
            потоковых данных для высшего уровня сетевых решений. Большинство
            продуктов компании использует сетевые процессоры собственной
            разработки и работает под управлением JUNOS — операционной системы,
            основанной на FreeBSD и содержащей полный набор POSIX-совместимых
            команд и инструментов. JUNOS также известна высокой степенью
            регресс-тестирования (три релиза в год). <br />
            <br />
            Аналитическое агентство Gartner присвоило статус лидера компании
            Juniper в квадранте, посвящённом центрам обработки данных.
          </p>
        </div>
