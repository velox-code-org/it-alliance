import Logo from "../../assets/vendors/communigatepro.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function CommunigateproPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  CommuniGate Pro (АО «Система безопасных коммуникаций»)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="CommuniGate Pro (АО «Система безопасных коммуникаций»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>CommuniGate Pro</strong> — российская универсальная коммуникационная платформа, разработанная компанией АО «Система безопасных коммуникаций» («СБК»). Решение специализируется на предоставлении полного спектра корпоративных коммуникационных сервисов в монолитной программной архитектуре, включая электронную почту, календари, контакты, мгновенные сообщения, голосовую и видеосвязь, а также инструменты для совместной работы.
              <br/><br/>
              На рынке платформа позиционируется как гибкое и масштабируемое решение для организаций любого масштаба — от малого бизнеса до крупных корпораций и сервис-провайдеров, способное обслуживать до миллионов пользователей. CommuniGate Pro отличается высокой степенью безопасности (сертификат ФСТЭК России по 5 уровню доверия), включено в Единый реестр российского ПО Минцифры России и поддерживает работу на более чем 15 операционных системах, включая все популярные отечественные ОС.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://communigatepro.ru/" target="_blank">
