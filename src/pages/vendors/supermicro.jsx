import Vector370 from "../../assets/vendors/supermicro-logo370.png";
import Vector480 from "../../assets/vendors/supermicro-logo480.png";
import Vector576 from "../../assets/vendors/supermicro-logo576.png";
import Vector768 from "../../assets/vendors/supermicro-logo768.png";
import Vector992 from "../../assets/vendors/supermicro-logo992.png";
import Vector1024 from "../../assets/vendors/supermicro-logo1024.png";
import Vector1260 from "../../assets/vendors/supermicro-logo1260.png";
import Vector1440 from "../../assets/vendors/supermicro-logo1440.png";
import Vector1600 from "../../assets/vendors/supermicro-logo1600.png";
import Vector1920 from "../../assets/vendors/supermicro-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function SupermicroPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Supermicro</b> - мировой технологический лидер, стремящийся
            первыми вывести на рынок инновации для предприятий, облаков,
            искусственного интеллекта, Метавселенной и телекоммуникационной
            инфраструктуры 5G/Edge IT. Мы являемся поставщиком комплексных
            ИТ-решений для стоечных систем, который разрабатывает и создает
            экологически чистый и энергосберегающий ассортимент серверов, систем
            хранения данных, коммутаторов, программного обеспечения, а также
            услуги глобальной поддержки.
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="http://supermicro.com/" target="_blank">
            <button
