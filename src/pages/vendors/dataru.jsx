import Logo from "../../assets/vendors/dataru.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function DataruPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  Группа компаний «Данные - это» (DataRu)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Группа компаний «Данные - это» (DataRu)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Группа компаний «Данные - это»</strong> — российский производитель и интегратор технологических решений, специализирующийся на создании комплексной цифровой инфраструктуры для бизнеса и государственных организаций. Ключевая специализация компании охватывает разработку и внедрение решений для импортозамещения, построение защищенных ИТ-ландшафтов, а также интеграцию передовых технологий, включая системы искусственного интеллекта.
              <br/><br/>
              На рынке DataRu позиционируется как провайдер комплексных услуг, сочетающий экспертизу в области лучших мировых практик с фокусом на создание надежной и суверенной цифровой среды. Компания предлагает заказчикам полный цикл работ — от консультаций и проектирования до внедрения и последующей поддержки, стремясь к оптимальным срокам реализации проектов. Важным направлением деятельности является развитие собственной команды экспертов, создание программ обучения и повышения квалификации специалистов, а также обеспечение возможностей для карьерного роста внутри группы компаний.
              <br/><br/>
              Штаб-квартира расположена в Москве. Группа компаний активно участвует в формировании технологического суверенитета страны, выступая надежным партнером для организаций, переходящих на отечественное программное обеспечение и оборудование.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://dataru.ru/" target="_blank">
