import Logo from "../../assets/vendors/evadapower.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function EvadapowerPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Evada" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Evada</strong> — китайская компания, работающая в сфере силовой электроники и систем электропитания. Основана в 1998 году, штаб-квартира и основные производственные мощности расположены в городе Сямынь (Xiamen), Китай. Компания ориентирована на разработку решений для обеспечения бесперебойного и стабильного электроснабжения.
              <br/><br/>
              EVADA специализируется на производстве источников бесперебойного питания (UPS), инверторов, систем распределения и мониторинга электропитания. Продукция компании применяется в центрах обработки данных, промышленности, телекоммуникациях, энергетике и коммерческих объектах. EVADA присутствует на международных рынках и поставляет решения для корпоративных и инфраструктурных проектов.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://ru.evadapower.com/" target="_blank">
