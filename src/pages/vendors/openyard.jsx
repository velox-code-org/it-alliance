...
export default function OpenyardPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="OpenYard (ООО «Открытый двор»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>OpenYard</strong> — российский разработчик и производитель серверного оборудования, специализирующийся на создании надежных и технологически независимых решений для корпоративных заказчиков. Ключевая специализация компании охватывает проектирование и производство серверов, систем хранения данных и другого инфраструктурного оборудования, ориентированного на максимальную совместимость с различными программными и аппаратными платформами.
              <br/><br/>
              Компания позиционирует себя как динамичного разработчика, сочетающего экспертизу ведущих российских ИТ-компаний с гибкостью стартапа. OpenYard делает акцент на обеспечении технологической независимости заказчиков, предлагая оборудование, которое не привязывает бизнес к конкретным вендорам и позволяет гибко адаптироваться к изменениям рынка. Важными направлениями деятельности являются развитие собственной исследовательской команды (R&D), комплексное сопровождение проектов на всех этапах — от внедрения до сервисного обслуживания в формате 24/7, а также развитие удобного сервисного портала для клиентов.
              <br/><br/>
              Штаб-квартира компании расположена в Москве. OpenYard активно развивается как игрок на рынке импортозамещения, предлагая оборудование, способное заменить ушедшие зарубежные бренды и обеспечить стабильную работу критической ИТ-инфраструктуры предприятий.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://openyard.ru/" target="_blank">
