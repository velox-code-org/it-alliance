import Logo from "../../assets/vendors/r7-office.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function R7OfficePage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  Р7-Офис (АО «Новые коммуникационные технологии»)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Р7-Офис (АО «Новые коммуникационные технологии»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Р7-Офис</strong> — российский разработчик, создающий комплексные офисные решения для бизнеса, государственных органов и образовательных учреждений. Ключевая специализация компании — разработка интегрированной офисной среды, включающей редакторы документов, таблиц и презентаций, а также сервисы для коммуникации (корпоративная почта, календарь, мессенджер «Команда»), файловое хранилище («Р7-Диск») и инструменты для управления проектами.
              <br/><br/>
              На рынке компания позиционируется как поставщик полноценной альтернативы зарубежным офисным пакетам (включая продукты Microsoft и Google Workspace), ориентированной на импортозамещение и построение единой защищенной цифровой среды. Решения Р7-Офис совместимы с российскими операционными системами (на базе Linux), Windows и macOS, а также доступны в веб-версии.
            </p>
          </div>
