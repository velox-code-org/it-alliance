import Logo from "../../assets/vendors/sinexcel.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function SinexcelPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Shenzhen Sinexcel Electric Co., Ltd." className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Sinexcel</strong> — китайская публичная компания (код акции: 300693), являющаяся глобальным поставщиком базового оборудования и решений для построения «энергетического интернета» (Energy Internet). Ключевая специализация компании — разработка и производство устройств силовой электроники для управления качеством электроэнергии и подключения к сети, а также решений в области накопления энергии и электрозарядной инфраструктуры. На рынке Sinexcel позиционируется как ведущий разработчик передовых технологий в области преобразования и контроля электроэнергии, стремящийся к созданию более продуктивного и устойчивого энергетического будущего.
              <br/><br/>
              Компания занимает лидирующие позиции в Китае в сфере решений для низковольтного качества электроэнергии. Sinexcel располагает шестью крупными производственными базами, а ее продукция и решения представлены в 54 странах мира. Значительная часть персонала (около 40%) занята в исследованиях и разработках, а портфель интеллектуальной собственности компании насчитывает более 110 патентованных технологий.
              <br/><br/>
              Штаб-квартира компании расположена в Шэньчжэне (провинция Гуандун, Китай). На протяжении более чем 13 лет компания углубленно работает в области силовой электроники, поставляя свою продукцию для различных отраслей промышленности и энергетики по всему миру.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://en.sinexcel.com/" target="_blank">
