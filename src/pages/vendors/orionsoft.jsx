import Logo from "../../assets/vendors/orionsoft.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function OrionsoftPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Orion soft (ООО «Орион софт»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.orionsoft.ru/" target="_blank">
