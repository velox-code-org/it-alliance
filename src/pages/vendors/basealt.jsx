import Logo from "../../assets/vendors/basealt.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function BasealtPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Базальт СПО (ООО «Базальт СПО»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Базальт СПО</strong> — российский разработчик операционных систем семейства «Альт» (Linux), предназначенных для использования в государственных учреждениях, корпоративном секторе, образовательных организациях и частными пользователями. Ключевая специализация компании — создание защищенных операционных систем, обладающих встроенными программными средствами защиты информации и сертифицированных Федеральной службой по техническому и экспортному контролю (ФСТЭК России).
              <br/><br/>
              На рынке компания позиционируется как один из ведущих разработчиков системного ПО с собственной инфраструктурой разработки, развиваемой на протяжении 25 лет. Это позволяет компании создавать операционные системы, отвечающие самым разным потребностям — от персональных рабочих станций до серверов корпоративного уровня.
            </p>
          </div>
