import Vector370 from "../../assets/vendors/brocade-logo370.png";
import Vector480 from "../../assets/vendors/brocade-logo480.png";
import Vector576 from "../../assets/vendors/brocade-logo576.png";
import Vector768 from "../../assets/vendors/brocade-logo768.png";
import Vector992 from "../../assets/vendors/brocade-logo992.png";
import Vector1024 from "../../assets/vendors/brocade-logo1024.png";
import Vector1260 from "../../assets/vendors/brocade-logo1260.png";
import Vector1440 from "../../assets/vendors/brocade-logo1440.png";
import Vector1600 from "../../assets/vendors/brocade-logo1600.png";
import Vector1920 from "../../assets/vendors/brocade-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function BrocadePages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Brocade</b> - американская технологическая компания,
            специализирующаяся на продуктах для сетей хранения данных, в
            настоящее время дочерняя компания Broadcom Inc. Компания известна
            своими продуктами и технологиями для сетей хранения данных Fibre
            Channel. До приобретения компания расширилась на смежные рынки,
            включая широкий спектр аппаратных и программных продуктов IP /
            Ethernet. <br />
            <br />
            Расположена в Кремниевой долине. Компания проектирует, производит и
            продаёт комплексные решения, а также программное обеспечение для
            управления сетями хранения данных. Brocade оказала значительное
            влияние на индустрию СХД в целом, разработав первые fibre channel
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://brocade-ru.ru/" target="_blank">
            <button
