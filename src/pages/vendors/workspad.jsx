import Logo from "../../assets/vendors/workspad.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function WorkspadPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="WorksPad (ООО «Воркспад» / «Ай-Тех»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>WorksPad</strong> — российский разработчик, создающий интегрированную платформу для превращения мобильных устройств (iPad, iPhone, Android) в полнофункциональные и защищенные корпоративные рабочие места. Ключевая специализация компании — обеспечение безопасного удаленного доступа сотрудников к корпоративным ресурсам (почта, календарь, контакты, документы) с возможностью полноценного редактирования файлов и организации совместной работы в едином приложении.
              <br/><br/>
              На рынке платформа позиционируется как комплексное решение класса Enterprise Mobile Workplace, которое расширяет защищенный периметр компании на мобильные устройства сотрудников. WorksPad объединяет в одном нативном приложении широкий набор продуктивных функций для iOS и Android, обеспечивая единый пользовательский опыт и высокий уровень безопасности.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.workspad.com/" target="_blank">
