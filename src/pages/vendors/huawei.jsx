import Vector370 from "../../assets/vendors/huawei-logo370.png";
import Vector480 from "../../assets/vendors/huawei-logo480.png";
import Vector576 from "../../assets/vendors/huawei-logo576.png";
import Vector768 from "../../assets/vendors/huawei-logo768.png";
import Vector992 from "../../assets/vendors/huawei-logo992.png";
import Vector1024 from "../../assets/vendors/huawei-logo1024.png";
import Vector1260 from "../../assets/vendors/huawei-logo1260.png";
import Vector1440 from "../../assets/vendors/huawei-logo1440.png";
import Vector1600 from "../../assets/vendors/huawei-logo1600.png";
import Vector1920 from "../../assets/vendors/huawei-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function HuaweiPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Huawei</b> — китайский производитель и ведущий мировой поставщик
            интеллектуальных устройств и инфраструктуры в области
            информационно-коммуникационных технологий (ИКТ). Наша миссия —
            принести цифровые технологии каждому человеку, дому и организации
            для создания полностью подключенного интеллектуального мира. <br />
            <br />
            В то время как пишется новая глава в истории интеллектуальной
            трансформации, Huawei работает с клиентами и партнерами по всему
            миру, чтобы беспрепятственно интегрировать
            информационно-коммуникационные технологии (ИКТ) с отраслевыми
            сценариями. Это позволяет внедрять инновации в инфраструктуру,
            которые способствуют цифровой и интеллектуальной трансформации,
            поддерживая широкий спектр моделей и приложений искусственного
            интеллекта (ИИ) для всех отраслей. <br />
            <br />
            Вместе с партнерами мы помогаем отраслям становиться
            интеллектуальными и быстрее. От «умных» городов, финансов и
            транспорта до энергетики, производства, образования, здравоохранения
            и интернет-сервисов - будущее уже пишется, и пишется сегодня.
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://www.huawei.ru" target="_blank">
            <button
