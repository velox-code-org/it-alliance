import Logo from "../../assets/vendors/astra.svg";
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Группа Астра" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Группа Астра</strong> — российский разработчик, специализирующийся на создании системного программного обеспечения. Компания занимает лидирующие позиции на отечественном ИТ-рынке как разработчик операционных систем семейства Astra Linux, а также активно развивает экосистему совместимых программных и аппаратных продуктов. Ключевая специализация включает разработку защищенных операционных систем для рабочих станций и серверов, средств виртуализации, а также предоставление услуг по миграции ИТ-инфраструктуры на отечественное ПО и его технической поддержке.
              <br/><br/>
              Основным продуктом компании является операционная система Astra Linux, известная своими высокими характеристиками безопасности, включая реализацию мандатного контроля доступа для работы с данными различной степени конфиденциальности. В рамках экосистемы «Группа Астра» реализует программу технологического партнерства «Ready for Astra», в ходе которой на середину 2024 года подтверждена совместимость с продуктами компании для более чем 2800 решений сторонних разработчиков. Штаб-квартира расположена в Москве. Компания также реализует экспортный потенциал, присутствуя на рынках стран СНГ, и ведет активную деятельность в области развития образовательных проектов и подготовки ИТ-специалистов.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://astra.ru/" target="_blank">
