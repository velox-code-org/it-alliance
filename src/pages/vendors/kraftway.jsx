import Logo from "../../assets/vendors/kraftway.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function KraftwayPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  Kraftway (АО «Крафтвэй корпорэйшн ПЛС»)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Kraftway (АО «Крафтвэй корпорэйшн ПЛС»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Kraftway</strong> — один из ведущих российских разработчиков и производителей высокотехнологичного оборудования и программного обеспечения, специализирующийся на создании инновационных решений для государственных структур и корпоративного сектора. Ключевая специализация компании охватывает производство защищенных персональных компьютеров, серверов, систем хранения данных, тонких клиентов, а также разработку программно-аппаратных комплексов и встроенного программного обеспечения.
              <br/><br/>
              На рынке Kraftway позиционируется как технологический лидер, ориентированный на создание не просто аналогов зарубежных продуктов, а принципиально новых конкурентоспособных технологий, отвечающих самым жестким требованиям информационной безопасности. Компания обладает уникальной исследовательской экспертизой и собственной производственной базой, позволяющей выпускать защищенную продукцию в промышленных масштабах.
              <br/><br/>
          ...
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://kraftway.ru/" target="_blank">
