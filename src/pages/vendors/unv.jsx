import Vector370 from "../../assets/vendors/unv-logo370.png";
import Vector480 from "../../assets/vendors/unv-logo480.png";
import Vector576 from "../../assets/vendors/unv-logo576.png";
import Vector768 from "../../assets/vendors/unv-logo768.png";
import Vector992 from "../../assets/vendors/unv-logo992.png";
import Vector1024 from "../../assets/vendors/unv-logo1024.png";
import Vector1260 from "../../assets/vendors/unv-logo1260.png";
import Vector1440 from "../../assets/vendors/unv-logo1440.png";
import Vector1600 from "../../assets/vendors/unv-logo1600.png";
import Vector1920 from "../../assets/vendors/unv-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function UnvPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Uniview</b> (сокращённо UNV) — китайский производитель систем
            видеонаблюдения. Основан в 2005 году, штаб-квартира находится в
            Ханчжоу. Компания специализируется на оборудовании для
            видеонаблюдения, включая IP-камеры и сетевые видеомагнитофоны.{" "}
            <br />
            <br />
            В декабре 2011 года подразделение видеонаблюдения было куплено у
            Hewlett-Packard фондом, аффилированным с Bain Capital. С 2012 года
            Uniview продаёт решения для обеспечения «общественной безопасности»
            китайскому правительству в Тибетском автономном районе. <br />
            <br />
            UNV — первопроходец и лидер в области IP-видеонаблюдения.
            Первоначально компания представила решения IP-видеонаблюдения в
            Китае, сейчас UNV третья по величине компания на рынке Китая. В 2017
            году Uniview заняла 6 место на глобальном рынке в своей отрасли.{" "}
            <br />
            <br />
            UNV предлагает комплексные продукты для IP-видеонаблюдения, в том
            числе IP-камеры, IP-видеорегистраторы, энкодеры, декодеры,
            клиентское ПО и приложения для хранения данных, охватывающие
            различные сферы, включая розничную торговлю, наблюдение в зданиях,
            промышленность, образование, коммерческий сектор, городскую
            безопасность и т. д.
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://ru-uniview.com/" target="_blank">
            <button
