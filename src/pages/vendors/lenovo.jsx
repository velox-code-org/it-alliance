...
import Vector370 from "../../assets/vendors/lenovo-logo370.png";
import Vector480 from "../../assets/vendors/lenovo-logo480.png";
import Vector576 from "../../assets/vendors/lenovo-logo576.png";
import Vector768 from "../../assets/vendors/lenovo-logo768.png";
import Vector992 from "../../assets/vendors/lenovo-logo992.png";
import Vector1024 from "../../assets/vendors/lenovo-logo1024.png";
import Vector1260 from "../../assets/vendors/lenovo-logo1260.png";
import Vector1440 from "../../assets/vendors/lenovo-logo1440.png";
import Vector1600 from "../../assets/vendors/lenovo-logo1600.png";
import Vector1920 from "../../assets/vendors/lenovo-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import Scroll_down from "../../components/icons/scroll_down.svg";
import { Link } from "react-router-dom";

export default function LenovoPages() {
  const table_ = [
    {
    ...
    {
      title:
        "Серверы высокой степени надежности ThinkSystem Mission Critical Servers",
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Lenovo Group Limited</b> («Лено́во Груп Лимитед») — китайская
            транснациональная корпорация, выпускающая персональные компьютеры,
            ноутбуки, смартфоны, ряд другой электроники, а также клавиатуры,
            компьютерные мыши, колонки, наушники, защитные чехлы и иные
            аксессуары к ней. Является крупнейшим производителем персональных
            компьютеров в мире с долей на рынке более 20%, а также занимает
            пятое место по производству мобильных телефонов. Штаб-квартира
            компании Lenovo расположена в Пекине (КНР), а зарегистрирована
            компания в Гонконге. Основные исследовательские центры компании
            расположены в Пекине, Шанхае и Шэньчжэне (КНР), а также в Ямато
            (Япония).
          </p>
        </div>
