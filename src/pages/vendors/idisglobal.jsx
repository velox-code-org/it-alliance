import Logo from "../../assets/vendors/idisglobal.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function IdisglobalPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="IDIS (IDIS Co., Ltd.)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>IDIS</strong> — международная компания, специализирующаяся на создании интегрированных систем видеонаблюдения. Ключевая специализация включает разработку и производство полного спектра оборудования: IP-камер, видеорегистраторов, программного обеспечения (включая системы видеоаналитики), а также мониторов и видеостен. На рынке компания позиционируется как поставщик комплексных решений с акцентом на кибербезопасность, отказоустойчивость систем и соответствие высоким стандартам качества, предлагая собственные запатентованные технологии.
              <br/><br/>
              Основные продукты и технологические решения компании охватывают области IP-видеонаблюдения, HD-TVI систем, видеоаналитики, а также специализированные разработки, такие как технология IDIS Intelligent Codec (Интеллектуальный кодек) для оптимизации трафика и технология IDIS Chained FingerPrint для защиты от несанкционированного доступа и фальсификации видеоданных. Компания делает упор на комплексный подход («все в одном»), обеспечивая совместимость и стабильность работы всех компонентов системы.
              <br/><br/>
              Головная компания IDIS Co., Ltd. основана в 1997 году. Интересы компании в России и странах СНГ представляет официальное подразделение IDIS Russia (ООО «Авикс ДЦ»), расположенное в Москве, которое отвечает за развитие партнерской сети, техническую поддержку, проведение обучения и реализацию проектов на территории региона.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.idisglobal.ru/" target="_blank">
