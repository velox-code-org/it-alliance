import Vector370 from "../../assets/vendors/xfusion-logo370.png";
import Vector480 from "../../assets/vendors/xfusion-logo480.png";
import Vector576 from "../../assets/vendors/xfusion-logo576.png";
import Vector768 from "../../assets/vendors/xfusion-logo768.png";
import Vector992 from "../../assets/vendors/xfusion-logo992.png";
import Vector1024 from "../../assets/vendors/xfusion-logo1024.png";
import Vector1260 from "../../assets/vendors/xfusion-logo1260.png";
import Vector1440 from "../../assets/vendors/xfusion-logo1440.png";
import Vector1600 from "../../assets/vendors/xfusion-logo1600.png";
import Vector1920 from "../../assets/vendors/xfusion-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function XfusionPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            Компания <b>xFusion Digital Technologies</b> является одним из
            ведущих мировых разработчиков вычислительной инфраструктуры и
            IT-услуг. В настоящее время клиентами компании являются заказчики в
            130 странах и регионах, включая крупные организации в сфере
            финансов, транспорта и энергетики, а также операторов связи и
            Интернета. <br />
            <br />
            Серверы FusionServer обладают целым рядом преимуществ. Оптимизация
            на уровне системы позволяет увеличить производительность сервера,
            интегрированные компоненты и возможности решения обеспечивают более
            высокую вычислительную мощность. Надежность достигается благодаря
            интеллектуальной технологии самовосстановления после сбоев памяти.
            По оценкам стабильность системы на 30% выше, чем в среднем по
            отрасли. Поддержка технологии DEMT2.0 позволяет экономить до 18%
            энергии.
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://www.xfusion.com/" target="_blank">
            <button
