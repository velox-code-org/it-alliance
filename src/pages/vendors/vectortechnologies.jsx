import Logo from "../../assets/vendors/vectortechnologies.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function VectortechnologiesPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  Вектор Технологии (ООО «Вектор Технологии»)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Вектор Технологии (ООО «Вектор Технологии»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Вектор Технологии</strong> — российская компания, специализирующаяся на разработке и производстве сетевого оборудования. Ключевое направление деятельности включает создание коммутаторов, маршрутизаторов и других активных сетевых устройств для построения корпоративных и операторских сетей связи. На рынке компания позиционируется как разработчик, ориентированный на импортозамещение и создание технологически независимых решений для различных отраслей.
              <br/><br/>
              Компания располагает штаб-квартирой и исследовательскими мощностями в городе Иннополис (Республика Татарстан) — одном из ведущих российских центров развития высоких технологий и инноваций. Это местоположение подчеркивает фокус компании на разработках и тесную интеграцию с экосистемой ИТ-образования и передовых исследований. Продуктовый портфель и технические характеристики оборудования, а также информация о реестровых записях и партнерах требуют уточнения на официальном сайте компании или из других открытых источников.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://vectortechnologies.ru/" target="_blank">
