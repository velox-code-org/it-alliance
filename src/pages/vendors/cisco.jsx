import Vector370 from "../../assets/vendors/cisco-logo370.png";
import Vector480 from "../../assets/vendors/cisco-logo480.png";
import Vector576 from "../../assets/vendors/cisco-logo576.png";
import Vector768 from "../../assets/vendors/cisco-logo768.png";
import Vector992 from "../../assets/vendors/cisco-logo992.png";
import Vector1024 from "../../assets/vendors/cisco-logo1024.png";
import Vector1260 from "../../assets/vendors/cisco-logo1260.png";
import Vector1440 from "../../assets/vendors/cisco-logo1440.png";
import Vector1600 from "../../assets/vendors/cisco-logo1600.png";
import Vector1920 from "../../assets/vendors/cisco-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function CiscoPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Cisco Systems</b> — американская транснациональная компания,
            которая разрабатывает и продаёт сетевое оборудование,
            предназначенное в основном для крупных организаций и
            телекоммуникационных предприятий.
            <br />
            <br />
            Также компания разрабатывает программное обеспечение в сфере
            информационной безопасности. Кроме этого, компания организует
            обучающие программы и сертификацию специалистов в областях сетевого
            оборудования и интернета.
            <br />
            <br />
            Компания Cisco Systems славится своей широкой линейкой сетевого
            оборудования и решений, направленных на улучшение и оптимизацию
            коммуникаций и информационных процессов в бизнесе всех масштабов и
            областей. Продукция корпорации создается с учетом новейших
            технологий и требований современного рынка, что позволяет компаниям
            эффективно использовать свои ресурсы и поддерживать высокий уровень
            безопасности и производительности сетевой инфраструктуры.
          </p>
        </div>
