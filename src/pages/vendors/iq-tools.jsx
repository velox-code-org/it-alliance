import Logo from "../../assets/vendors/iq-tools.png";
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="АйКьюТулс (ООО «АйКьюТулс»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>АйКьюТулс (IQTools)</strong> — российский производитель телекоммуникационного оборудования, специализирующийся на создании комплексных решений для построения и управления корпоративными сетями связи. Ключевая специализация компании охватывает разработку и производство высокопроизводительных сетевых коммутаторов (уровней L2/L3 с поддержкой портов до 100 Гбит/с), оборудования беспроводного доступа (точки доступа и контроллеры Wi-Fi), систем унифицированных коммуникаций (включая IP-АТС и шлюзы), а также программных продуктов для централизованного мониторинга и управления сетевой инфраструктурой.
              <br/><br/>
              На рынке компания позиционируется как разработчик с высокой степенью локализации производства, предлагающий оборудование, включенное в реестр российской промышленной продукции (номер реестровой записи: №21411 от 08.02.2024). IQTools делает акцент на комплексном подходе к потребностям заказчика, предоставляя не только оборудование, но и круглосуточную техническую поддержку, возможность тестирования решений в собственном демо-парке, а также обучение работе с продуктами в своем учебном центре.
              <br/><br/>
              Штаб-квартира и офис компании расположены в Москве (Земляной Вал, 64, стр. 2). Наличие собственной команды разработчиков и склада готовой продукции позволяет компании обеспечивать оперативную отгрузку и гибко подходить к вопросам гарантийного обслуживания и ценообразования.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://iq-tools.net/" target="_blank">
