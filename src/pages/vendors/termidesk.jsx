import Logo from "../../assets/vendors/termidesk.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function TermideskPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Termidesk (ООО «Ювейон» / UVEON)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Termidesk</strong> — российский разработчик программных решений для организации виртуальных рабочих мест и обеспечения удаленного доступа к корпоративным данным и приложениям. Компания специализируется на создании мультиплатформенных продуктов, ориентированных на государственные организации и бизнес, с акцентом на безопасность, масштабируемость и простоту внедрения.
              <br/><br/>
              На рынке компания позиционируется как поставщик надежных технологий доступа к данным, предлагающий решения для построения инфраструктуры любого масштаба — от небольших организаций до крупных распределенных структур.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://termidesk.ru/" target="_blank">
