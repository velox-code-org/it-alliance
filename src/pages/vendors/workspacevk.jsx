import Logo from "../../assets/vendors/workspacevk.png";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function WorkspacevkPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            <div className="flex flex-col justify-between min-h-[80px] xs:min-h-[90px] sm:min-h-[100px] py-1 xs:py-2">
              ...
              <div className="bottom-0">
                <div className="
                  ...
                  VK WorkSpace (ООО «ВК Цифровые Технологии» / VK Tech)
                </div>
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="VK WorkSpace (ООО «ВК Цифровые Технологии» / VK Tech)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>VK WorkSpace</strong> — корпоративная платформа для совместной работы и коммуникаций, разработанная компанией VK Tech (входит в экосистему VK). Решение объединяет в едином защищенном приложении полный набор сервисов для организации работы команд: корпоративную почту, календарь, мессенджер, аудио- и видеозвонки, диск для хранения файлов, доски для совместной работы и онлайн-документы.
              <br/><br/>
              На рынке платформа позиционируется как комплексная зарубежным аналогам (Microsoft 365, Google Workspace), предлагая российским компаниям любого масштаба прогнозируемую стоимость владения, прозрачное масштабирование и соответствие требованиям законодательства. Решение доступно как в облачной модели (сервисы на инфраструктуре VK), так и для размещения на собственных серверах заказчика («на частном домене»).
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://workspace.vk.ru/" target="_blank">
