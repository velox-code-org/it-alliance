import Logo from "../../assets/vendors/eltex-co.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function EltexCoPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="ELTEX (АО «ЭЛТЕКС»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>ELTEX</strong> — один из ведущих российских разработчиков и производителей телекоммуникационного оборудования, специализирующийся на создании комплексных решений для построения сетей связи различного масштаба — от корпоративных и операторских сетей до систем «умного города». Компания предлагает широкий портфель продуктов, включающий коммутаторы доступа и агрегации (в т.ч. с поддержкой PoE), маршрутизаторы, оборудование беспроводного доступа (Wi-Fi точки доступа и контроллеры), абонентские устройства (CPE, ONT), решения GPON, VoIP-шлюзы, IP-АТС и программное обеспечение для управления сетевой инфраструктурой.
              <br/><br/>
              На рынке компания позиционируется как поставщик полного цикла, осуществляющий собственные научно-исследовательские и опытно-конструкторские работы (НИОКР), производство и послепродажную поддержку. ELTEX входит в перечень системообразующих организаций российской экономики в сфере радиоэлектронной промышленности. Штаб-квартира и основное производство расположены в наукограде Кольцово (Новосибирская область).
              <br/><br/>
              Ключевым направлением деятельности является обеспечение технологической независимости и информационной безопасности объектов критической инфраструктуры. Продукция компании широко используется операторами связи, государственными учреждениями, промышленными предприятиями и в жилищно-коммунальном хозяйстве (ЖКХ) для построения защищенных и отказоустойчивых сетей.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://eltex-co.com/" target="_blank">
