...
export default function SangrusPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Sangrus (ООО «Сангрус»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Sangrus</strong> — российская компания-разработчик, специализирующаяся на создании программных продуктов для построения гиперконвергентной инфраструктуры (HCI) и инфраструктуры виртуальных рабочих столов (VDI). Ключевая специализация компании — предложение комплексных платформ, которые объединяют в себе виртуализацию серверных мощностей, систем хранения данных (СХД), сетей и даже систем информационной безопасности (таких как антивирус и NGFW) в единое программно-определяемое решение.
              <br/><br/>
              На рынке компания позиционирует себя как технологического партнера, предлагающего высокотехнологичные решения для организации удаленных рабочих мест (VDI) с возможностью работы на каналах связи с низкой пропускной способностью и поддержкой технологий vGPU для графических адаптеров NVIDIA и AMD. В описании продуктов прослеживается связь с технологиями компании Sangfor, однако Sangrus выступает как локальный партнер, предоставляющий техническую поддержку на русском языке, включая базу знаний, помощь в настройке, обновлении и проверке «здоровья» оборудования.
              <br/><br/>
              Штаб-квартира компании расположена в Москве. Основной деятельностью является не только внедрение решений, но и обеспечение их полного жизненного цикла: от поставки и настройки до технической поддержки с регламентированным временем реакции (от 1 часа на критические заявки в рабочие дни).
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://sangrus.com/" target="_blank">
