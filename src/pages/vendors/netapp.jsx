import Vector370 from "../../assets/vendors/netapp-logo370.png";
import Vector480 from "../../assets/vendors/netapp-logo480.png";
import Vector576 from "../../assets/vendors/netapp-logo576.png";
import Vector768 from "../../assets/vendors/netapp-logo768.png";
import Vector992 from "../../assets/vendors/netapp-logo992.png";
import Vector1024 from "../../assets/vendors/netapp-logo1024.png";
import Vector1260 from "../../assets/vendors/netapp-logo1260.png";
import Vector1440 from "../../assets/vendors/netapp-logo1440.png";
import Vector1600 from "../../assets/vendors/netapp-logo1600.png";
import Vector1920 from "../../assets/vendors/netapp-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function NetappPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            Компания <b>NetApp</b> – один из ведущих производителей аппаратного
            и программного обеспечения для хранения и управления данными.
            Операционная система Data ONTAP признана лидером на рынке
            операционных систем для хранения данных. Решения NetApp помогают
            заказчикам по всему миру проектировать, строить и развивать свою
            ИТ-инфраструктуру, обеспечивая максимальную производительность,
            эффективность и защиту данных. NetApp активно сотрудничает с
            ведущими мировыми ИТ-производителями для создания интегрированных
            решений для управления данными. Компания NetApp и ее партнеры по
            глобальному технологическом альянсу — Microsoft, SAP, VMware, Cisco,
            Citrix и др. — ориентированы на обеспечение высокой
            производительности и эффективности работы приложений и виртуальных
            сред в современных центрах обработки данных.
          </p>
        </div>
