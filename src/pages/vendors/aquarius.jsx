import Logo from "../../assets/vendors/aquarius.svg";
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Aquarius" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Aquarius</strong> — российская IT-компания, работающая в сфере разработки и производства вычислительной техники и инфраструктурных решений. Основана в 1989 году, штаб-квартира расположена в России. Компания входит в число крупнейших отечественных производителей компьютерного и серверного оборудования.
              <br/><br/>
              Aquarius специализируется на выпуске серверов, систем хранения данных, персональных компьютеров, ноутбуков и специализированных решений для корпоративного и государственного сектора. Продукция компании включена в реестр российской промышленной продукции и применяется в проектах по цифровизации, импортозамещению и развитию критической ИТ-инфраструктуры.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.aq.ru/" target="_blank">
