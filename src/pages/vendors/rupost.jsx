...
export default function RupostPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="RuPost (ООО «РуПост»)" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>RuPost</strong> — российский разработчик, специализирующийся на создании корпоративных почтовых систем и сервисов для организаций любого масштаба. Ключевая специализация компании — разработка почтового сервера RuPost и кросс-платформенного почтового клиента Desktop X, обеспечивающих полный цикл работы с корпоративной электронной почтой, календарями, задачами и контактами.
              <br/><br/>
              На рынке компания позиционируется как поставщик надежного, масштабируемого и удобного в администрировании решения, которое является лидером в категории «Корпоративная почта» (согласно рейтингам 2024 и 2025 годов). RuPost предлагает комплексный подход к импортозамещению, обеспечивая возможность быстрой и корректной миграции с зарубежных систем (например, Microsoft Exchange) и режим сосуществования с ними для постепенного перехода.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.rupost.ru/" target="_blank">
