import Logo from "../../assets/vendors/dallmeier.svg";
import Vector from "../../assets/vendors/Vector.svg";
import {Link} from "react-router-dom";

export default function DallmeierPage() {
  return (
        ...
        <div className="
          ...
          <div className="flex justify-between gap-3 xs:gap-4 sm:gap-6 mb-4 xs:mb-5 sm:mb-6">
            ...
            <div className="relative
              ...
              <div className="px-4">
                <img src={Logo} alt="Dallmeier electronic GmbH & Co. KG" className="w-full h-auto object-contain svg-big-icon"/>
              </div>
          ...
          <div className="
            ...
            <p className="text-justify">
              <strong>Компания Dallmeier</strong> является немецким производителем профессиональных систем видеонаблюдения и решений для обеспечения видеобезопасности. Ключевая специализация компании — разработка и производство оборудования и программного обеспечения по стандарту «Сделано в Германии» с акцентом на полный контроль цепочки создания стоимости. На рынке компания позиционируется как поставщик решений, соответствующих высоким требованиям кибербезопасности и строгим принципам защиты данных, включая соответствие европейскому регламенту GDPR (Общий регламент по защите данных) с подходом «Безопасность и конфиденциальность как неотъемлемая часть проекта» (Security and Privacy by Design).
              <br/><br/>
              Основные продукты компании включают камеры семейства Domera® для универсального применения, а также запатентованную технологию мультифокальных сенсорных камер Panomera®, позволяющую эффективно контролировать обширные пространства и большие расстояния. Программное обеспечение для управления видео SeMSy® компании Dallmeier охватывает спектр от мобильных решений до систем корпоративного уровня. Компания основана в 1984 году и остается семейным предприятием. Штаб-квартира расположена в Регенсбурге, Германия. Продукты Dallmeier используются через широкую сеть инсталляторов и интеграторов в различных отраслях, включая обеспечение безопасности на стадионах, в курортных комплексах и других объектах.
            </p>
          </div>
          <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
            ...
            <a href="https://www.dallmeier.com/en" target="_blank">
