import Vector370 from "../../assets/vendors/hitachi-logo370.png";
import Vector480 from "../../assets/vendors/hitachi-logo480.png";
import Vector576 from "../../assets/vendors/hitachi-logo576.png";
import Vector768 from "../../assets/vendors/hitachi-logo768.png";
import Vector992 from "../../assets/vendors/hitachi-logo992.png";
import Vector1024 from "../../assets/vendors/hitachi-logo1024.png";
import Vector1260 from "../../assets/vendors/hitachi-logo1260.png";
import Vector1440 from "../../assets/vendors/hitachi-logo1440.png";
import Vector1600 from "../../assets/vendors/hitachi-logo1600.png";
import Vector1920 from "../../assets/vendors/hitachi-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import { Link } from "react-router-dom";

export default function hitachiPages() {
  return (
    <div
      ...
      >
        ...
        >
          <p className="text-justify">
            <b>Hitachi</b> — один из крупнейших в мире японских конгломератов.
            Основан в 1910 году в городе Хитати. Главный офис компании находится
            в Токио. <br />
            <br />
            Hitachi — финансово-промышленная группа, которая работает в таких
            отраслях, как электроника, электротехника, машиностроение, средства
            автоматизации, медицинское оборудование и комплексные проекты.
          </p>
        </div>
