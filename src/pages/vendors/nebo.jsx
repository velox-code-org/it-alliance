...
import Vector370 from "../../assets/vendors/nebo-logo370.png";
import Vector480 from "../../assets/vendors/nebo-logo480.png";
import Vector576 from "../../assets/vendors/nebo-logo576.png";
import Vector768 from "../../assets/vendors/nebo-logo768.png";
import Vector992 from "../../assets/vendors/nebo-logo992.png";
import Vector1024 from "../../assets/vendors/nebo-logo1024.png";
import Vector1260 from "../../assets/vendors/nebo-logo1260.png";
import Vector1440 from "../../assets/vendors/nebo-logo1440.png";
import Vector1600 from "../../assets/vendors/nebo-logo1600.png";
import Vector1920 from "../../assets/vendors/nebo-logo1920.png";
import Vector from "../../assets/vendors/Vector.svg";
import Scroll_down from "../../components/icons/scroll_down.svg";
import { Link } from "react-router-dom";

export default function NeboPages() {
  const table_ = [
    {
      ...
      >
        ...
        >
          <p className="text-justify">
            Небо передает простор, открытость и свежесть, гармонично
            сочетающуюся с масштабом и величием. Здесь заключено стремление к
            бесконечным высотам, новым достижениям и техническим инновациям,
            которые хочется разделить со всеми клиентами <b>NEBO Systems</b>.{" "}
            <br />
            <br />
            Главное стремление NEBO Systems - создавать культуру непрерывных
            инноваций, которая помогает клиентам, воплощая основные ценности и
            принципы.{" "}
          </p>
        </div>
        ...
        <div className="mb-20 flex items-center gap-1.5 xs:gap-2 sm:gap-3 my-4 xs:my-5 sm:my-6 px-1 xs:px-2">
          ...
          <a href="https://nebosystems.ru/" target="_blank">
            <button
